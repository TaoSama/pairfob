(function () {
  ...
  const zh = {
    ...
    "wait.note": "手机和电脑都能确认，哪边确认另一边立刻就是",
    ...
    "cap.lede": "默认自动选择：P2P 直连且浏览器适合时优先真终端，否则进入控制。也可以固定模式。电脑当时做不到的，不会画出来。",
    "tile1.h": "一眼看完所有会话",
    "tile1.p": "哪个在等你、哪个还在跑，同一份列表里排好。",
    "tile2.h": "终端里确认，不会盲按 Enter",
    "tile2.p": "Agent 等你时，提示留在画面里。用按键垫上下选择，再按 Enter。对话模式点「去确认」。",
    "ask.yes": "是",
    "ask.no": "否",
    "ask.keys": "↑ ↓ Enter",
    "tile3.h": "用系统键盘接着说",
    ...
    "tile4.h": "自动、控制、终端、对话",
    "tile4.p": "默认自动：P2P 直连且浏览器适合时优先真终端，否则控制。也可以为会话固定模式。",
    "mode.auto": "自动",
    "mode.control": "控制",
    "mode.term": "终端",
    "mode.chat": "对话",
    ...
    "tile7.h": "看文件、改 diff、写批注",
    "tile7.p": "打开当前会话的工作区。浏览目录、看未提交更改，点一行写批注再发给 Agent。",
    "tile8.h": "看各家订阅余量",
    "tile8.p": "设置里显示这台电脑已登录的 Codex、Claude、Copilot、Cursor、Grok、Antigravity 额度。没有数据不会当成零。",
    "tile6.h": "一部设备，多台电脑",
  ...
  const en = {
    ...
    "wait.note": "Either side can confirm; the other side is already there",
    ...
    "cap.lede": "Auto prefers the real terminal on P2P when the browser supports it, and otherwise uses Control. You can pin any mode. What the live Herdr cannot do is not drawn.",
    "tile1.h": "Every session in one list",
    "tile1.p": "Who needs you, who is still running — one ordered list.",
    "tile2.h": "Confirm in the terminal, not by surprise",
    "tile2.p": "When the agent needs you, the prompt stays on screen. Use the keypad to choose, then Enter. In Chat, tap Go confirm.",
    "ask.yes": "Yes",
    "ask.no": "No",
    "ask.keys": "↑ ↓ Enter",
    ...
    "tile4.h": "Auto, control, terminal, chat",
    "tile4.p": "Auto prefers the real terminal on P2P when the browser supports it, and otherwise uses Control. You can pin a mode per session.",
    "mode.auto": "Auto",
    ...
    "tile7.h": "Files, diffs, comments",
    "tile7.p": "Open this session's workspace. Browse the tree, read uncommitted diffs, tap a line, and send comments to the agent.",
    "tile8.h": "Subscription quota",
    "tile8.p": "Settings shows allowance for Codex, Claude, Copilot, Cursor, Grok, and Antigravity on this computer. Missing data is never shown as zero.",
