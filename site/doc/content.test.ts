...
describe("user-facing documentation", () => {
  ...
  test("install is a grantless one-liner", async () => {
    ...
    expect(start).toContain("curl -fsSL https://pair.taoai.site/install.sh | sh");
    expect(start).not.toContain("sh -s -- --grant");
    expect(zhStart).not.toContain("sh -s -- --grant");
    expect(install).toContain("curl -fsSL https://pair.taoai.site/install.sh | sh");
    ...
    expect(faq).toContain("curl -fsSL https://pair.taoai.site/install.sh | sh");
    expect(devices).toContain("curl -fsSL https://pair.taoai.site/install.sh | sh");
