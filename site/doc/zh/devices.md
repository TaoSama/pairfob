---
title: 多台设备
description: 再配对一台就再扫一次码。设置里可以解除其他设备；电脑上也可以 forget。
---
...
手机设置页也会列出已配对设备：当前设备标成「这台手机」，其他设备显示在线或离线。已解除的不会再出现在名单里。

## 解除

手机 **设置 → 已配对设备** 里，其他设备有 **解除**。确认后那台设备立即断开，需要重新扫码。**危险操作 → 解除这台手机的配对** 只解除自己。
...
某一行的 **忘记** 只删这台浏览器里的凭证。电脑上的设备名单还在，除非你在那边 `forget`，或在设置的已配对设备里 **解除**。**解除这台手机的配对** 仍然只影响当前这台电脑的配对关系。
